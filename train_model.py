...
if __name__ == "__main__":
    # Get Dataset
    train, test = get_data('data/train_dataset.hdf5', 'data/test_dataset.hdf5')
    ...
    # Fit Model and Save
    hist = model.fit(train, validation_data=test, epochs=epochs,callbacks=[tensorboard_callback,model_checkpoint,early_stop,reduce_learning_rate])
    model.save('./model_save/'+'GalaxyMNIST_convXpress_'+str(learning_rate)+'_'+str(epochs)+'_final.h5')
